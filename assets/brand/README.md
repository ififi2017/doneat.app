...
Source of truth is the product repo’s `assets/brand/` ([008](https://github.com/ififi2017/Off-Work-Countdown/blob/main/plans/008-brand-doneat.md)). This folder is a copy for the site. Do not invent a second geometry.

| File | Use on this site |
| --- | --- |
...
Filenames keep the product-repo names on purpose so diffs stay obvious. The displayed brand is **DoneAt**.
