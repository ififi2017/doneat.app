...
export type CompareStatus = "included" | "limited";
...
const copy: Record<ContentLocale, DownloadShowcaseCopy> = {
  "zh-CN": {
    ...
    comparisonLede: "倒计时、今日已赚和跨夜班次两边都有。差别在于它怎么待在手边。",
    featureLabel: "功能",
    mobileLabel: "手机 / iPad",
    desktopLabel: "电脑",
    rows: [
  ...
  en: {
    ...
    comparisonLede: "The countdown, today’s earnings, and overnight shifts are on both. The difference is how the remaining time stays in reach.",
